...
venue: "Name of University"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "Month NN-NN"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "M:00 am - N:00 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
